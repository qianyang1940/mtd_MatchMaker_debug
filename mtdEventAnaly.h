...
TH2D *hdeltaR_lvsPt;
TH2D *hdeltaR_svsPt;
TH2D *hdeltaR_lvsPt_Two;
TH2D *hdeltaR_svsPt_Two;
TH1D *hModule;
TH2D *hDeltazvsStrip;
TH2D *hDeltazvsStrip_ISMATCH;
TH2D *hDeltazvsStrip_ISMATCHNebi;
TH2D *hDeltazvsStrip_ISMATCH_TWO;
TH2D *hDeltazvsStrip_ISMATCHNebi_TWO;
TH1D *hTrackprojZ;
TH1D *hTrackprojCell;
